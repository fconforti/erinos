...
%w[check_time send_email draft_email check_drafts check_inbox read_email search_email reply_email add_contact list_contacts update_contact remove_contact].each do |tool|
